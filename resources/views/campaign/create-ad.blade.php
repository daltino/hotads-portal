    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-1">
                ...
                <br/><br/>
                <form class="form-horizontal" role="form" method="POST" action="{{ url('/campaign/create-ad') }}">
                    {!! csrf_field() !!}

                    <div class="form-group">
                        <label class="col-md-4 control-label">Choose Location(s)*</label>
                        <div class="col-md-6">
                            <select name="locations" multiple id="locations" class="select2-container-multi">
                                <option value="PH Mall">Port Harcourt Mall</option>
                                <option value="Abuja Airport">Abuja Airport</option>
                                <option>Dolphin Highrise</option>
                                <option value="Farm City">Farm City, Lekki</option>
                                <option>Lekki Library</option>
                                <option value="Marco Polo">Marco Polo, Lekki</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file" class="form-control" name="graphicad1">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file" class="form-control" name="graphicad2">
                        </div>
                    </div>
